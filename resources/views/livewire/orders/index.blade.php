                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="px-2 py-1 text-xs rounded-full 
                                                    @if($order->status->title === 'Табурет') bg-blue-100 text-blue-800
                                                    @elseif($order->furniture->title === 'Стул') bg-yellow-100 text-yellow-800
                                                    @elseif($order->furniture->title === 'Кресло') bg-green-100 text-green-800
                                                    @elseif($order->furniture->title === 'Диван') bg-green-100 text-green-800
